...
_ln:     file format elf32-i386-freebsd
...
main(int argc, char *argv[])
{
      ...
      11:	89 4d f8             	mov    %ecx,0xfffffff8(%ebp)
  if(argc != 3){
      14:	8b 45 f8             	mov    0xfffffff8(%ebp),%eax
  ...
  if(link(argv[1], argv[2]) < 0)
      35:	8b 55 f8             	mov    0xfffffff8(%ebp),%edx
      38:	8b 42 04             	mov    0x4(%edx),%eax
      3b:	83 c0 08             	add    $0x8,%eax
      3e:	8b 10                	mov    (%eax),%edx
      40:	8b 4d f8             	mov    0xfffffff8(%ebp),%ecx
      43:	8b 41 04             	mov    0x4(%ecx),%eax
      46:	83 c0 04             	add    $0x4,%eax
      49:	8b 00                	mov    (%eax),%eax
      4b:	89 54 24 04          	mov    %edx,0x4(%esp)
      4f:	89 04 24             	mov    %eax,(%esp)
      52:	e8 3d 03 00 00       	call   394 <link>
      57:	85 c0                	test   %eax,%eax
      59:	79 32                	jns    8d <main+0x8d>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
      5b:	8b 55 f8             	mov    0xfffffff8(%ebp),%edx
      5e:	8b 42 04             	mov    0x4(%edx),%eax
      61:	83 c0 08             	add    $0x8,%eax
      64:	8b 10                	mov    (%eax),%edx
      66:	8b 4d f8             	mov    0xfffffff8(%ebp),%ecx
      69:	8b 41 04             	mov    0x4(%ecx),%eax
      6c:	83 c0 04             	add    $0x4,%eax
      6f:	8b 00                	mov    (%eax),%eax
      71:	89 54 24 0c          	mov    %edx,0xc(%esp)
      75:	89 44 24 08          	mov    %eax,0x8(%esp)
      79:	c7 44 24 04 d7 10 00 	movl   $0x10d7,0x4(%esp)
      80:	00 
      81:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      88:	e8 b3 04 00 00       	call   540 <printf>
  exit();
      8d:	e8 a2 02 00 00       	call   334 <exit>
      92:	90                   	nop    
      93:	90                   	nop    
      94:	90                   	nop    
      95:	90                   	nop    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     4cc:	0f b6 80 08 11 00 00 	movzbl 0x1108(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     637:	75 25                	jne    65e <printf+0x11e>
          s = "(null)";
     639:	c7 45 ec eb 10 00 00 	movl   $0x10eb,0xffffffec(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     70f:	a1 24 11 00 00       	mov    0x1124,%eax
  ...
  freep = p;
     ...
     7d0:	a3 24 11 00 00       	mov    %eax,0x1124
}
     7d5:	c9                   	leave  
     7d6:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     851:	a1 24 11 00 00       	mov    0x1124,%eax
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     875:	a1 24 11 00 00       	mov    0x1124,%eax
     87a:	89 45 f8             	mov    %eax,0xfffffff8(%ebp)
     87d:	83 7d f8 00          	cmpl   $0x0,0xfffffff8(%ebp)
     881:	75 23                	jne    8a6 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     883:	c7 45 f8 1c 11 00 00 	movl   $0x111c,0xfffffff8(%ebp)
     88a:	8b 45 f8             	mov    0xfffffff8(%ebp),%eax
     88d:	a3 24 11 00 00       	mov    %eax,0x1124
     892:	a1 24 11 00 00       	mov    0x1124,%eax
     897:	a3 1c 11 00 00       	mov    %eax,0x111c
    base.s.size = 0;
     89c:	c7 05 20 11 00 00 00 	movl   $0x0,0x1120
     8a3:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     8f9:	a3 24 11 00 00       	mov    %eax,0x1124
      return (void*) (p + 1);
    ...
    if(p == freep)
     909:	a1 24 11 00 00       	mov    0x1124,%eax
...
00000c70 <inet_aton>:
 ...
 int inet_aton(const char *cp, struct in_addr *addr)
 {
     ...
     e75:	8b 80 f4 10 00 00    	mov    0x10f4(%eax),%eax
     e7b:	ff e0                	jmp    *%eax
...
char *inet_ntoa(struct in_addr addr)
{
  ...
  rp = str;
     f2d:	c7 45 f0 28 11 00 00 	movl   $0x1128,0xfffffff0(%ebp)
  ap = (u8_t *)&s_addr;
  ...
  *--rp = 0;
  ...
  return str;
    1006:	b8 28 11 00 00       	mov    $0x1128,%eax
}
